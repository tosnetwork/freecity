...
```mermaid
flowchart LR
    R["Eligible residents"] -->|"authorize and recall"| E["Executive offices"]
    R -->|"elect or select"| C["Council"]
    C -->|"approve rules and budgets"| T["Treasury committee"]
    E -->|"propose and administer"| C
    J["Independent civic panels"] -->|"review rules, disputes, and appeals"| E
    J -->|"review"| S["Public safety and moderation operations"]
    T -->|"execute only approved transactions"| N["TOS Network"]
    N -->|"finalized asset and contract facts"| A["Public audit projection"]
```
